            ...
            return (
                <span className="ml-1 inline-flex items-center" title="Read">
                    <svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.071 0.653a.5.5 0 0 1 .058.706l-5.5 6.5a.5.5 0 0 1-.736.017L2.543 5.478a.5.5 0 0 1 .714-.7l2.01 2.044 5.098-6.11a.5.5 0 0 1 .706-.059z" fill="#60A5FA" />
                        <path d="M14.071 0.653a.5.5 0 0 1 .058.706l-5.5 6.5a.5.5 0 0 1-.736.017l-.5-.508a.5.5 0 0 1 .714-.7l.147.15 5.111-6.106a.5.5 0 0 1 .706-.059z" fill="#60A5FA" />
                    </svg>
                </span>
            );
        }

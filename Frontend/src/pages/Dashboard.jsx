            ...
            <div className="h-14 bg-[#0a0a12] border-b border-[#1e1e2a] flex items-center justify-between px-4 md:px-5 flex-shrink-0">
                ...
                {currentUser?.isAdmin && (
                    <button
                        ...
                        className="px-3.5 py-1.5 md:px-4 md:py-2 bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 text-xs md:text-sm font-medium rounded-lg transition-colors cursor-pointer flex items-center gap-2"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 hidden md:block">
